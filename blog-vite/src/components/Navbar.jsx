    ...
    <div className="navbar">
      ...
      <div className="nav-right">
        ...
        <div
          ...
          ref={menuRef}
          onMouseEnter={() => {
            if (!isLocked) setOpenMenu(true); // hover open
          }}
          onMouseLeave={() => {
            if (!isLocked) setOpenMenu(false); // hover close
          }}
        >
          <img
          ...
          {openMenu && (
            <div className="more-dropdown">
              {/* ✅ hover → only username */}
              {!isLocked && (
                <div className="more-item username">{username}</div>
              )}
